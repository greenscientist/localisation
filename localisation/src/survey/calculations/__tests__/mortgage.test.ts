    ...
    describe('mortgageMonthlyPayment', () => {
        ...
        describe('edge cases', () => {
            it('should handle zero interest rate', () => {
                const result = mortgageMonthlyPayment(120000, 0, 12);
                expect(result).toBe(10000); // 120000 / 12
            });

            it('should handle zero principal', () => {
                const result = mortgageMonthlyPayment(0, 0.1, 12);
                expect(result).toBe(0);
            });

            it('should throw error for invalid inputs', () => {
                expect(() => mortgageMonthlyPayment(-100000, 0.05, 300)).toThrow();
                expect(() => mortgageMonthlyPayment(100000, -0.05, 300)).toThrow();
                expect(() => mortgageMonthlyPayment(100000, 0.05, 0)).toThrow();
                expect(() => mortgageMonthlyPayment(100000, 0.05, -1)).toThrow();
            });
